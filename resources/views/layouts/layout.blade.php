...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-mini"><b>N</b>TA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>NTA</span>
    </a>
      ...
      <ul class="sidebar-menu " data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../../index.html"><i class="fa fa-circle-o "></i>List Food</a></li>
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Menu Top</a></li>
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Category Food</a></li>
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Order Table</a></li>
          </ul>
        </li>
...
<!-- AdminLTE App -->
<script src="{{ asset('js/js_layout/adminlte.min.js') }}"></script>
